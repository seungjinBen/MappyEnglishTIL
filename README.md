...
---
* [mappyenglish.com](https://mappyenglish.com/) 으로 배포완료(26.3)
---
* 세션 만료시 강제 로그아웃 처리
...
---
* 26.4.10 갑자기 서버가 죽어버림
  - 이유 추정: 메모리 쌓이다 꽉 참, 최근 무거운 로직 추가(미션 진도율 동기화, 스테이지 잠금 계산)
* 서버 다시 살리고, 스왑 메모리 설정
---
* 프로젝트의 정체성 문제
  - 공부하는 앱(현재 모습) -> 여행의 설렘 앱(재구성한 모습)
* 유럽 도시의 현재 시간 기준 장소 추천
* 미션 2개에서 1개로 바꿈: 다시 1개에서 2개로 바꾸고 싶을때
  - BottomSheet.tsx와 chat/[id]/page.tsx파일에 MISSIONS_TO_COMPLETE 변수값 나중에 2로 바꾸면 됌
